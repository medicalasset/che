...
public class EditorTabWidget extends Composite implements EditorTab, ContextMenuHandler, ResourceChangedHandler, FileEventHandler {
    ...
    public EditorTabWidget(@Assisted VirtualFile file,
        ...
        closeButton.addDomHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                eventBus.fireEvent(FileEvent.createCloseFileEvent(EditorTabWidget.this.getId(), EditorTabWidget.this.file));
            }
        }, ClickEvent.getType());
    }
    ...
    public void onClick(@NotNull ClickEvent event) {
        if (NativeEvent.BUTTON_LEFT == event.getNativeButton()) {
            ...
            eventBus.fireEvent(FileEvent.createCloseFileEvent(this.getId(), file));
        }
    }
